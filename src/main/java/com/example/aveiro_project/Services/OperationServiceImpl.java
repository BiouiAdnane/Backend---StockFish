...
public class OperationServiceImpl implements OperationService{
    ...
    @Override
    public Operation saveOperation(Operation operation) throws QuantiteInsufficient {
        //operation.setDateOpertaion(new Date());
        log.info("Saving New Operation");
        Depot depot = operation.getDepot();
        ...
        if(operation.getTypeOpr()==TypeOp.E){
            if (operation.getQuantite()+depot.getQuantiteActuelle()>depot.getQauntiteMax())
                throw new QuantiteInsufficient("quantite max depasse");
            ...
            if(article.getQuantite_Article()<operation.getQuantite() || depot.getQuantiteActuelle()<operation.getQuantite())
    ...
    @Override
    public Operation updateOperation(Operation operation) throws QuantiteInsufficient {
        // baqi khassha tqad
